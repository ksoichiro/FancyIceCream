...
public class FancyIceCreamRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.FOOD, FancyIceCreamModItems.SWEET_BERRY_ICE_CREAM.get())
            .pattern("A")
            .pattern("B")
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.DECORATIONS, FancyIceCreamModItems.ICE_CREAM_CUP.get())
            .pattern("A A")
            .pattern(" A ")
