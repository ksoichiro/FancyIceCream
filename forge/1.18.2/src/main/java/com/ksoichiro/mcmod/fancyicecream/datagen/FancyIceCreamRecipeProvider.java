...
public class FancyIceCreamRecipeProvider extends RecipeProvider {
    public FancyIceCreamRecipeProvider(DataGenerator generator) {
        super(generator);
    }
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.VANILLA_ICE_CREAM.get(), 3)
            .pattern("ABA")
            .pattern("CBC")
            .pattern(" D ")
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.APPLE_ICE_CREAM.get())
            .pattern("A")
            .pattern("B")
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.CHOCO_CHIP_ICE_CREAM.get())
            .pattern("A")
            .pattern("B")
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.CHOCOLATE_ICE_CREAM.get())
            .pattern("AA")
            .pattern("B ")
            .define('A', Items.COCOA_BEANS)
            .define('B', FancyIceCreamModItems.VANILLA_ICE_CREAM.get())
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.GLOW_BERRY_ICE_CREAM.get())
            .pattern("A")
            .pattern("B")
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.GOLDEN_APPLE_ICE_CREAM.get())
            .pattern("A")
            .pattern("B")
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.HONEY_ICE_CREAM.get())
            .pattern("A")
            .pattern("B")
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.SWEET_BERRY_ICE_CREAM.get())
            .pattern("A")
            .pattern("B")
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.ICE_CREAM_STAND.get())
            .pattern("A A")
            .pattern(" A ")
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.TRIPLE_ICE_CREAM_STAND.get())
            .pattern("A A")
            .pattern(" B ")
            .define('A', Items.IRON_NUGGET)
        ...
        ShapedRecipeBuilder.shaped(FancyIceCreamModItems.ICE_CREAM_CUP.get())
            .pattern("A A")
            .pattern(" A ")
