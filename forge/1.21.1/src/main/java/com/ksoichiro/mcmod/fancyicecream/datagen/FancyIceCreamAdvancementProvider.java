    ...
    public static class IceCreamAdvancements implements AdvancementGenerator {
        ...
        public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
            AdvancementHolder root = Advancement.Builder.advancement()
                ...
                .save(saver, ResourceLocation.fromNamespaceAndPath(FancyIceCreamMod.MOD_ID, "root"));
            ...
            Advancement.Builder.advancement()
                ...
                .save(saver, ResourceLocation.fromNamespaceAndPath(FancyIceCreamMod.MOD_ID, "ice_cream_master"));
            ...
            AdvancementHolder decorator = Advancement.Builder.advancement()
                ...
                .save(saver, ResourceLocation.fromNamespaceAndPath(FancyIceCreamMod.MOD_ID, "decorator"));
            ...
            Advancement.Builder.advancement()
                ...
                .save(saver, ResourceLocation.fromNamespaceAndPath(FancyIceCreamMod.MOD_ID, "triple_decorator"));
            ...
            Advancement.Builder.advancement()
                ...
                .save(saver, ResourceLocation.fromNamespaceAndPath(FancyIceCreamMod.MOD_ID, "cup_decorator"));
        }
    }
}
