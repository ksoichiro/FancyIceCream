...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new FancyIceCreamRecipeProvider(generator));
        generator.addProvider(event.includeServer(), new FancyIceCreamAdvancementProvider(generator, existingFileHelper));
    }
}
