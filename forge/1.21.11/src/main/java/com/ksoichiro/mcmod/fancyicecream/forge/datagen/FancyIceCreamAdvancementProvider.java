        ...
        public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
            AdvancementHolder root = Advancement.Builder.advancement()
                .display(FancyIceCreamForgeItems.VANILLA_ICE_CREAM.get(),
                    ...
                    Identifier.fromNamespaceAndPath(FancyIceCream.MOD_ID, "gui/advancements/backgrounds/ice_cream"),
                ...
                .save(saver, Identifier.fromNamespaceAndPath(FancyIceCream.MOD_ID, "root"));
            ...
            Advancement.Builder.advancement()
                ...
                .save(saver, Identifier.fromNamespaceAndPath(FancyIceCream.MOD_ID, "ice_cream_master"));
            ...
            AdvancementHolder decorator = Advancement.Builder.advancement()
                ...
                .save(saver, Identifier.fromNamespaceAndPath(FancyIceCream.MOD_ID, "decorator"));
            ...
            Advancement.Builder.advancement()
                ...
                .save(saver, Identifier.fromNamespaceAndPath(FancyIceCream.MOD_ID, "triple_decorator"));
            ...
            Advancement.Builder.advancement()
                ...
                .save(saver, Identifier.fromNamespaceAndPath(FancyIceCream.MOD_ID, "cup_decorator"));
        }
    }
}
