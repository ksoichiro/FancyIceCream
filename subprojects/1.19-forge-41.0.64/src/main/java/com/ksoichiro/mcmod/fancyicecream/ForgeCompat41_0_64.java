...
public class ForgeCompat41_0_64 implements IForgeCompat {
    ...
    public IItemTagCompat createItemTag(String name) {
        ItemTagCompat41_0_64 t = new ItemTagCompat41_0_64();
    ...
    public IRegistryObjectCompat registerItem(String name, Supplier item) {
        return new RegistryObjectCompat41_0_61(ITEMS.register(name, item));
    }

    @Override
    @SuppressWarnings({"unchecked", "rawtypes"})
    public IRegistryObjectCompat registerEntityType(String name, Supplier entityType) {
        return new RegistryObjectCompat41_0_61(getEntityTypeDeferredRegister().register(name, entityType));
    }
