...
public class TripleIceCreamStand extends IceCreamStand {
    protected static final DataParameter<ItemStack> DATA_ITEM2 = EntityDataManager.createKey(TripleIceCreamStand.class, DataSerializers.ITEMSTACK);
    protected static final DataParameter<ItemStack> DATA_ITEM3 = EntityDataManager.createKey(TripleIceCreamStand.class, DataSerializers.ITEMSTACK);
