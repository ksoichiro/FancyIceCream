...
public class TripleIceCreamStandRenderer<T extends IceCreamStand> extends IceCreamStandRenderer<T> {
    public static final ResourceLocation STAND_LOCATION = new ResourceLocation(FancyIceCream.MOD_ID, "block/triple_ice_cream_stand");
    ...
    protected ModelResourceLocation getModelResourceLoc() {
        return new ModelResourceLocation(new ResourceLocation(FancyIceCream.MOD_ID, "triple_ice_cream_stand"), "");
    }
